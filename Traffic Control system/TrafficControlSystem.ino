...
delay(3000);
digitalWrite(12,LOW);    //green is off for blinking next //to make green on and off 3 times
delay(500); digitalWrite(12,HIGH); delay(500); digitalWrite(12,LOW);
delay(500); digitalWrite(12,HIGH); delay(500); digitalWrite(12,LOW);
delay(500); digitalWrite(12,HIGH); delay(500); digitalWrite(12,LOW); //to turn yellow on once 
